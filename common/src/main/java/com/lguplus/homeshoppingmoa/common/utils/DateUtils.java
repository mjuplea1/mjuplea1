...
public class DateUtils {
	 ...
	 * @return
	 */
	public static LinkedHashMap<String, Object> getBetweenDateMap(String startDt, String endDt) {
		...
		while (!startDate.isAfter(endDate)) {
			hashMap.put(startDate.format(DateTimeFormatter.ofPattern("yyyy-MM-dd")), null);
