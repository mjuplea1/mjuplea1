...
public abstract class LoggerAspect {
    ...
    protected String getLogString(LogDetails logDetails) {
        ...
        sb.append(SEPARATOR).append("RESULT_CODE").append(KV_SEPARATOR).append(ResultCodeType.SUCCESS.code()); // 8자리, "1xxxxxxx : 정보, 2xxxxxxx : 성공, 3xxxxxxx : 클라이언트 에러, 4xxxxxxx : 서버에러(서비스), 5xxxxxxx : 서버에러(연동)"
